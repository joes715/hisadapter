...
(function ($) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_258, _259, _25a) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _258, dataType: "json", success: function (data) {
                    _259(data);
                }, error: function () {
        ...
        editors: _1c6,
        finder: {
            getTr: function (_25b, _25c, type, _25d) {
                type = type || "body";
                _25d = _25d || 0;
