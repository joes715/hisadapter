...
function jBoxWrapper(jQuery) {
    ...
    var jBox = function jBox(type, options) {
        ...
        this._create = function () {
            ...
            (this.options.closeOnClick == 'box') && this.wrapper.on('click', function () {
            ...
            if (this.options.closeButton) {
                ...
                this.closeButton = jQuery('<div class="jBox-closeButton jBox-noDrag"/>').on('click', function (ev) {
                    this.close({ignoreDelay: true});
        ...
        this._showOverlay = function () {
            ...
            if (!this.overlay) {
                ...
                this.options.closeOnClick == 'overlay' && this.overlay.on('click', function () {
                    this.close({ignoreDelay: true});
                }.bind(this));
...
(function (root, factory) {
    ...
    try {
        typeof jBoxConfirmWrapper !== 'undefined' && jBoxConfirmWrapper && jBoxConfirmWrapper(jBox, jQuery);
    } catch (e) {
        console.error(e);
    }
    try {
        typeof jBoxImageWrapper !== 'undefined' && jBoxImageWrapper && jBoxImageWrapper(jBox, jQuery);
    } catch (e) {
        console.error(e);
    }
    try {
        typeof jBoxNoticeWrapper !== 'undefined' && jBoxNoticeWrapper && jBoxNoticeWrapper(jBox, jQuery);
    } catch (e) {
        console.error(e);
    }
    return jBox;
